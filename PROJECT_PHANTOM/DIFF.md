...
| `criteria.py` file trigger words "written" (new in v3.6) and "changed" (pre-existing) had no dedicated tests | Two new `test_phantom.py` checks: `criteria.py written` and `test_phantom.py changed` (588 → 590) |
