...
1. Check session state:
   ```
   python3 /home/user/Cloud-code/PROJECT_PHANTOM/v2/phantom.py status
   ```
...
2. Run the heartbeat monitor:
   ```
   python3 /home/user/Cloud-code/PROJECT_PHANTOM/v2/heartbeat_runner.py
   ```
...
1. Run `python3 /home/user/Cloud-code/PROJECT_PHANTOM/v2/phantom.py status` and include the output
