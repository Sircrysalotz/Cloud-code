...
**Current version:** v3.6 (586 tests, in progress)
...
| v3.6 | `phantom/v3.6-readme-docs` | README.md, human-first commit format, criteria keyword fix, 2hr container lifetime test | 586 |
